...
export class WebGLTextureAtlas {
	 ...
	 */
	makeTextureForSurface(shared: WebGLSharedObject, surface: g.Surface): void {
	 ...
	 */
	private _assign(shared: WebGLSharedObject, surface: g.Surface, maps: WebGLTextureMap[]): void {
		// テクスチャアトラスに割り当てる
