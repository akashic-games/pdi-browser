...
export class ContainerController {
	...
	private _loadView(): void {
		const { primarySurfaceWidth: width, primarySurfaceHeight: height, rendererCandidates: rc } = this._rendererReq;
		...
		// 入力受け付けレイヤー > 描画レイヤー
		this.surface = RenderingHelper.createPrimarySurface(width, height, rc);
